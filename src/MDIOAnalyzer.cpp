...
MDIOAnalyzer::MDIOAnalyzer() : Analyzer2(), mSettings( new MDIOAnalyzerSettings() ), mSimulationInitialized( false )
{
...
void MDIOAnalyzer::ProcessAddrDataFrame()
{
    ...
    std::vector<U64>& arrows = ( mCurrentPacket.operation == MDIO_PACKET_READ ) ? mMdcNegedgeArrows : mMdcPosedgeArrows;
    for( U32 i = 0; i < 16; ++i )
    {
        BitState bit;
        GetBit( bit, arrows );
...
MDIOFrameType MDIOAnalyzer::GetDevType( const U64& value )
{
    ...
    {
    case DEV_RESERVED:
        return MDIO_C45_DEVTYPE_RESERVED;
    case DEV_PMD_PMA:
        return MDIO_C45_DEVTYPE_PMD_PMA;
    case DEV_WIS:
        return MDIO_C45_DEVTYPE_WIS;
    case DEV_PCS:
        return MDIO_C45_DEVTYPE_PCS;
    case DEV_PHY_XS:
        return MDIO_C45_DEVTYPE_PHY_XS;
    case DEV_DTE_XS:
        return MDIO_C45_DEVTYPE_DTE_XS;
    default:
        return MDIO_C45_DEVTYPE_OTHER;
    }
}
...
U32 MDIOAnalyzer::GenerateSimulationData( U64 minimum_sample_index, U32 device_sample_rate,
