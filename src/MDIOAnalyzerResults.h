...
enum MDIOFrameType
{
    ...
    MDIO_OP_R,
    MDIO_C45_OP_ADDR,
    MDIO_C45_OP_READ_INC_ADDR,
    MDIO_PHYADDR,
    MDIO_C22_REGADDR,
    MDIO_C45_DEVTYPE_RESERVED,
    MDIO_C45_DEVTYPE_PMD_PMA,
    MDIO_C45_DEVTYPE_WIS,
    MDIO_C45_DEVTYPE_PCS,
    MDIO_C45_DEVTYPE_PHY_XS,
    MDIO_C45_DEVTYPE_DTE_XS,
    MDIO_C45_DEVTYPE_OTHER,
    MDIO_TA,
    MDIO_C22_DATA,
    MDIO_C45_ADDR,
    MDIO_C45_DATA,
...
class MDIOAnalyzerResults : public AnalyzerResults
{
  ...
  protected:
    ...
    void GenOpString( const Frame& frame, const char* opcode_str0, const char* opcode_str1, const char* opcode_str2, bool tabular );
    ...
    void GenC45AddrDataString( const Frame& frame, DisplayBase display_base, const char* str0, const char* str1, const char* str2,
                               bool tabular );
