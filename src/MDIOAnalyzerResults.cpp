...
void MDIOAnalyzerResults::GenOpString( const Frame& frame, const char* opcode_str0, const char* opcode_str1, const char* opcode_str2,
                                       bool tabular )
{
    if( !tabular )
    {
...
void MDIOAnalyzerResults::GenC45AddrDataString( const Frame& frame, DisplayBase display_base, const char* str0, const char* str1,
                                                const char* str2, bool tabular )
{
    char number_str[ 128 ];
    AnalyzerHelpers::GetNumberString( frame.mData1, display_base, 16, number_str, 128 );
